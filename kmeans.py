'''
FOR only age and income and all others removed and 
to get only 2 attributes and then perform clustering 
'''
import numpy as np
import csv
import random
...
pl.title('Bank dataset with 5 clusters for {0} and {1}'.format(attributes[0],attributes[1]))
pl.show()